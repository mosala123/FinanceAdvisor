...
<h1 className="text-center pt-5 mb-4 text-primary">Automatic Invoice Generation System</h1>
  ...
  <div className="row g-4">
    ...
    <div className="col-md-4">
      <div className="card shadow-sm border-0">
        <img src={imageabout} className="card-img-top" alt="Mohamed Ibrahim Salah" />
        <div className="card-body text-center">
          ...
          <a href="mailto:elmosalah74@gmail.com" className="btn btn-primary mt-3">
    ...
    <div className="col-md-4">
      <div className="card shadow-sm border-0">
        <img src={imageabout} className="card-img-top" alt="Back-end Developer" />
        <div className="card-body text-center">
          ...
          <a href="mailto:ahmed.khaled@example.com" className="btn btn-primary mt-3">
            <i className="bi bi-envelope-fill me-2"></i> Contact
          </a>
        </div>
      </div>
    ...
    <div className="col-md-4">
      <div className="card shadow-sm border-0">
        <img src={imageabout} className="card-img-top" alt="Data Analyst" />
        <div className="card-body text-center">
          <h5 className="card-title fw-semibold">Mo Elgamal</h5>
          <p className="text-muted">Data Analyst</p>
          <p className="card-text">
            Expert in data visualization and analytics, ensuring our system provides
            insightful financial reports for better decision-making.
          </p>
          <a href="mailto:sara.ali@example.com" className="btn btn-primary mt-3">
            <i className="bi bi-envelope-fill me-2"></i> Contact
          </a>
        </div>
      </div>
    ...
    <div className="col-md-4">
      <div className="card shadow-sm border-0">
        ...
        <div className="card-body text-center">
          ...
          <a href="mailto:omar.hassan@example.com" className="btn btn-primary mt-3">
            <i className="bi bi-envelope-fill me-2"></i> Contact
          </a>
        </div>
      </div>
