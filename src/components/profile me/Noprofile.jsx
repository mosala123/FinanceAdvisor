          ...
          <div className="row align-items-center">
            ...
            >
              ...
              <p className="lead mb-4">
                A complete solution for creating and managing invoices
                automatically. Designed specifically for freelancers to help
                them organize their payments with ease and professionalism. Keep
                track of your transactions effortlessly and get detailed reports
                on your financial performance.
              </p>
              <p className="mb-4">
                Whether you're handling multiple clients or managing recurring
                payments, our system ensures smooth, error-free invoicing with
                real-time status updates. Take control of your finances today!
              </p>
        ...
        <div className="container">
          <div className="text-center mb-2">
            ...
            <p className="text-muted fs-5">
              Join thousands of users and freelancers building their future with
              us. Create an account and get started today!
            </p>
          </div>
          <div className="row justify-content-center align-items-center ">
            ...
            <div className="col-lg-5 col-md-12  mb-2">
              ...
              >
                ...
                <p className="text-muted">
                  Join us as a freelancer and offer your services.
                </p>
                <Link
              ...
              >
                <div className="card-body p-4">
                  ...
                  <p className="card-text">
                    Create professional invoices with a single click based on
                    your project data.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4 col-sm-12">
              ...
              >
                <div className="card-body p-4">
                  ...
                  <p className="card-text">
                    Send invoices automatically via email for seamless
                    transactions.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4 col-sm-12">
              ...
              >
                <div className="card-body p-4">
                  ...
                  <p className="card-text">
                    Get insightful reports on your income and earnings monthly
                    and annually.
                  </p>
                </div>
              </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-3 col-6">
              <div className="text-center">
                ...
                <p className="text-muted">
                  Fill in the details of the project or provided service.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-3 col-6">
              <div className="text-center">
                ...
                <p className="text-muted">
                  The system automatically generates the invoice.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-3 col-6">
              <div className="text-center">
                ...
                <p className="text-muted">
                  Send the invoice via email or WhatsApp.
                </p>
              </div>
            </div>
                ...
                <li className="mb-4 d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted mb-0">
                      Automate your invoicing process and generate invoices in
                      seconds, eliminating manual paperwork.
                    </p>
                  </div>
                </li>
                <li className="mb-4 d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted mb-0">
                      Our system ensures accuracy in calculations, minimizing
                      the risk of mistakes in financial records.
                    </p>
                  </div>
                </li>
                <li className="mb-4 d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted mb-0">
                      Access and manage all your invoices in one place, making
                      tracking and retrieval easy and efficient.
                    </p>
                  </div>
                </li>
                <li className="mb-4 d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted mb-0">
                      Get detailed insights into your earnings and expenditures
        ...
        <div className="container">
          ...
          <div className="border rounded p-4 bg-white shadow-sm m-2">
            ...
            <div className="mb-4">
              ...
              <p>
                Yes, the basic version is free with limited features. There are
                also paid subscriptions for more advanced features.
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <p>
                You can click on "Forgot Password" on the login page and enter
                your email to receive a reset link.
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <p>
                Yes, the system supports exporting invoices in PDF and Excel
                formats.
              </p>
            </div>
          </div>
