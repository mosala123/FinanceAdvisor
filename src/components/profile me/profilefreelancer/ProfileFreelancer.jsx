              ...
              <div className="card shadow-lg p-4 rounded w-100">
                <div className="text-center">
                  ...
                  <p className="text-muted">
                    {" "}
                    {userData.currentJob || "No Job"}
                  </p>{" "}
                  {/* استبدال occupation بـ currentJob */}
                </div>
                ...
                {editMode ? (
                  ...
                  <div className="mt-4 px-3 ">
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6 mb-2">
                        <FaBriefcase className="me-2 text-warning" /> Current
                        Job : {userData.currentJob || "No Job"}{" "}
                        {/* استبدال occupation بـ currentJob */}
                      </div>
                      <div className="col-12 col-md-6 mb-2">
                        <FaCode className="me-2 text-info" /> Skills :{" "}
                        {userData.skills || "No Skills Available"}
                      </div>
                      <div className="col-12 col-md-6 mb-2">
                        Experience :{" "}
                        {userData.experience || "No Experience Available"}
                      </div>
                      <div className="col-12 col-md-6 mb-2">
                        <FaGraduationCap className="me-2 text-warning" />{" "}
                        Education :{" "}
                        {userData.education || "No Education Available"}
                      </div>
                      <div className="col-12 col-md-6 mb-2">
                      ...
                      <div className="col-12 col-md-6 mb-2">
                        Languages :{" "}
                        {userData.languages || "No Languages Available"}
                      </div>
                    </div>
